...
public class TicTacToeBoard extends View {
    ...
    private void drawX(Canvas canvas, int row, int col) {
        ...
        canvas.drawLine((float)((col+1)*cellSize-cellSize*0.2),
                        ...
                        (float)(col*cellSize+0.2*cellSize),
                        (float)((row+1)*cellSize-0.2*cellSize),
                        paint);

        canvas.drawLine((float)(col*cellSize+0.2*cellSize),
                        (float) (row*cellSize+0.2*cellSize),
                        (float)((col+1)*cellSize-0.2*cellSize),
                        (float)((row+1)*cellSize-0.2*cellSize),
                        paint);
    }
